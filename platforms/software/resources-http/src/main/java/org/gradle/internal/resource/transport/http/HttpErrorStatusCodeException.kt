 ...
 */
@Contextual
open class HttpErrorStatusCodeException(method: String?, source: String?, val statusCode: Int, reason: String?) : RuntimeException(
    String.format(
        "Could not %s '%s'. Received status code %s from server: %s",
