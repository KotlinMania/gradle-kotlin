...
class ReadOnlyModuleVersionsCache(
...
) : DefaultModuleVersionsCache(timeProvider, cacheAccessCoordinator, moduleIdentifierFactory) {
    override fun store(key: ModuleAtRepositoryKey?, entry: ModuleVersionsCacheEntry?) {
    ...
    companion object {
        private fun operationShouldNotHaveBeenCalled(): UnsupportedOperationException? {
