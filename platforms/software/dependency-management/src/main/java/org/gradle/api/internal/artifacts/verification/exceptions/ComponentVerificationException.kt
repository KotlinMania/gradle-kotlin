...
class ComponentVerificationException : GradleException {
    private val component: ModuleComponentIdentifier
    private val causeErrorFormatter: Consumer<TreeFormatter?>?
     ...
     */
    constructor(message: String?, component: ModuleComponentIdentifier) : super(message) {
     ...
     *
     * @param component the component which failed the verification
     * @param causeErrorFormatter a consumer, which will be called with a [TreeFormatter], and can put extra details what happened
     */
    constructor(component: ModuleComponentIdentifier, causeErrorFormatter: Consumer<TreeFormatter?>?) {
        this.component = component
