...
internal class DefaultModuleExclude private constructor(private val module: String) : ModuleExclude {
    ...
    override fun excludes(module: ModuleIdentifier): Boolean {
        return this.module == module.getName()
    }
    ...
    override fun equals(o: Any?): Boolean {
        ...
        val that = o as DefaultModuleExclude
    ...
    companion object {
        fun of(module: String): ModuleExclude {
            return DefaultModuleExclude(module)
        }
    }
}
