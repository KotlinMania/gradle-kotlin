...
interface VisitedArtifactSet {
     ...
     */
    fun select(spec: ArtifactSelectionSpec): SelectedArtifactSet?

    /**
     * Legacy method of artifact selection, intended for use by
     * [org.gradle.api.artifacts.LenientConfiguration].
     */
    fun selectLegacy(spec: ArtifactSelectionSpec): SelectedArtifactResults?
}
