...
class IdeaModuleIml(xmlTransformer: XmlTransformer?, generateTo: File?) : XmlFileContentMerger(xmlTransformer) {
    /**
    ...
    init {
        IdeDeprecations.nagDeprecatedType(IdeaModuleIml::class.java)
