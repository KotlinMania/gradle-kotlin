 ...
 */
open class XmlFileContentMerger(var xmlTransformer: XmlTransformer) : FileContentMerger() {
    /**
     * Adds a closure to be called when the file has been created.
     * The XML is passed to the closure as a parameter in form of a [XmlProvider].
     ...
     */
    fun withXml(@DelegatesTo(XmlProvider::class) closure: Closure<*>?) {
