 ...
 *
 *
 * For examples see docs for [org.gradle.plugins.ide.eclipse.model.EclipseProject]
 * or [org.gradle.plugins.ide.idea.model.IdeaProject] and others.
 */
open class FileContentMerger {
    var whenMerged: MutableActionSet<*> = MutableActionSet<Any?>()
    var beforeMerged: MutableActionSet<*> = MutableActionSet<Any?>()
     ...
     */
    fun beforeMerged(action: Action<*>) {
     ...
     */
    fun beforeMerged(closure: Closure<*>?) {
        beforeMerged.add(ConfigureUtil.configureUsing<Any?>(closure))
    }
     ...
     * @param closure The closure to execute.
     */
    fun whenMerged(closure: Closure<*>?) {
        whenMerged.add(ConfigureUtil.configureUsing<Any?>(closure))
    }
}
