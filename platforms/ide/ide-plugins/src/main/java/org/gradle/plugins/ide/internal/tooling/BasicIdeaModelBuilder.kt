...
/**
 * Builds the [BasicIdeaProject] model
 * that contains the Idea module hierarchy without resolving dependencies.
 */
class BasicIdeaModelBuilder(private val ideaModelBuilder: IdeaModelBuilderInternal) : ToolingModelBuilder {
    ...
    companion object {
        private val MODEL_NAME: String = BasicIdeaProject::class.java.getName()
    }
}
