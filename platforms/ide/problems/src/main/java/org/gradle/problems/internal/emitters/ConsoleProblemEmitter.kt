...
class ConsoleProblemEmitter(private val warningMode: WarningMode) : ProblemEmitter {
    ...
    private fun shouldRender(problem: ProblemInternal): Boolean {
    ...
    companion object {
        private val LOGGER: Logger = LoggerFactory.getLogger(ConsoleProblemEmitter::class.java)
        private fun render(problem: ProblemInternal) {
            val sw = StringWriter()
