...
interface ProblemReporter {
    ...
    /**
     * A stable identifier for this reporter. Reporters are ordered by id before [.report] is called, so
     ...
     */
    fun report(reportDir: File, validationFailures: ProblemConsumer)
}
