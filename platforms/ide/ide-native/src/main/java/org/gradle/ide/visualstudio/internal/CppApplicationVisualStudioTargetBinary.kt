...
class CppApplicationVisualStudioTargetBinary(projectName: String?, projectPath: String?, component: CppComponent?, private val binary: CppExecutable, projectLayout: ProjectLayout?) :
    ...
    override fun getBuildTaskPath(): String {
        return binary.installTask.get().getPath()
    }

    override fun getOutputFile(): File {
        return binary.debuggerExecutableFile.get().getAsFile()
    }
}
