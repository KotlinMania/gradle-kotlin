...
class XcodeWorkspaceFile(transformer: XmlTransformer) : XmlPersistableConfigurationObject(transformer) {
    val defaultResourceName: String
        get() = "default.xcworkspacedata"
    ...
    fun addLocation(location: String?) {
        ...
        xml!!.appendNode("FileRef", attributes)
    }
}
