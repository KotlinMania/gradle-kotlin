...
class FetchTaskAction : BuildAction<GradleTask?> {
    public override fun execute(controller: BuildController?): GradleTask {
        val project: GradleProject = controller.getModel(GradleProject::class.java)
