...
class ParameterAction : BuildAction<CustomModel?> {
    public override fun execute(controller: BuildController?): CustomModel {
        return controller.getModel(CustomModel::class.java, CustomParameter::class.java, object : Action<CustomParameter?> {
