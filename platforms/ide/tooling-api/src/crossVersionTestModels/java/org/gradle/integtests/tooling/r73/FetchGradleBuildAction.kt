...
class FetchGradleBuildAction : BuildAction<GradleBuild?> {
    public override fun execute(controller: BuildController?): GradleBuild {
        controller.getBuildModel()
        controller.getModel(GradleBuild::class.java)
        controller.findModel(GradleBuild::class.java)
