...
class CustomModelBuildingAction : BuildAction<CustomModel?> {
    public override fun execute(controller: BuildController?): CustomModel {
        val model1: CustomModel = controller.getModel(CustomModel::class.java)
        val model2: CustomModel = controller.getModel(CustomModel::class.java)
