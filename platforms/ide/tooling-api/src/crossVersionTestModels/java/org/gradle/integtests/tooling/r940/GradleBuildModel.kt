...
internal class GradleBuildModel(model: GradleBuild?, failures: MutableCollection<out Failure?>) : Serializable {
    val model: GradleBuild?
    val failures: MutableCollection<String?>
