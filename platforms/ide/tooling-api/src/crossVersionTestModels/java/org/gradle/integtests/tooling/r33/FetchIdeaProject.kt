...
class FetchIdeaProject : BuildAction<IdeaProject?> {
    public override fun execute(controller: BuildController?): IdeaProject {
        return controller.getModel(IdeaProject::class.java)
    }
}
