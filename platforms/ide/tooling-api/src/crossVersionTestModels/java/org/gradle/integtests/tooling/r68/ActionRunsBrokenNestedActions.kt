...
class ActionRunsBrokenNestedActions : BuildAction<String?> {
    ...
    private class BrokenAction(private val name: String?) : BuildAction<Any?> {
        public override fun execute(controller: BuildController?): Any? {
            throw RuntimeException("broken: " + name)
        }
    }
}
