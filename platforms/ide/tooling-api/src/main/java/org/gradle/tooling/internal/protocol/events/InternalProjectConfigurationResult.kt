 ...
 * @since 5.1
 */
interface InternalProjectConfigurationResult : InternalOperationResult {
    /**
     * Returns the results of plugins applied as part of the configuration of this project.
     */
    val pluginApplicationResults: MutableList<out InternalPluginApplicationResult?>?
    ...
    interface InternalPluginApplicationResult {
         ...
         */
        val plugin: InternalPluginIdentifier?
