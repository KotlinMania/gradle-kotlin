...
interface PhasedBuildAction {
    val projectsLoadedAction: BuildActionWrapper<*>?

    val buildFinishedAction: BuildActionWrapper<*>?

    interface BuildActionWrapper<T> {
        val action: BuildAction<T?>?

        val handler: IntermediateResultHandler<in T?>?
    }
}
