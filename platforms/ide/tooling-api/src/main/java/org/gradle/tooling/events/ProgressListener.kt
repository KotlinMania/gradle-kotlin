...
interface ProgressListener {
     ...
     *
     *
     * The possible progress event types are listed in [OperationType]'s documentation.
     *
     *
     *
     * You can find out more about the operation for which progress is reported
     * by querying the descriptor using [ProgressEvent.getDescriptor].
     *
     *
     ...
     * @see OperationType
     */
    fun statusChanged(event: ProgressEvent?)
}
