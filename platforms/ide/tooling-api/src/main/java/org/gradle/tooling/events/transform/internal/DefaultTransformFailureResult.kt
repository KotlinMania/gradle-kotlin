...
class DefaultTransformFailureResult(startTime: Long, endTime: Long, failures: MutableList<out Failure?>?) : DefaultOperationFailureResult(startTime, endTime, failures), TransformFailureResult
