...
interface EclipseBuildCommand {
     ...
     * @see [Definition of ICommand.getBuilderName
     * @return The name of the build command. Does not return null.
    ](http://help.eclipse.org/mars/topic/org.eclipse.platform.doc.isv/reference/api/org/eclipse/core/resources/ICommand.html.getBuilderName--) */
    val name: String?
     ...
     *
     * Corresponds to the `org.eclipse.core.resources.ICommand#getBuilderName()` method in the Eclipse platform API.
     * @see [Definition of ICommand.getArguments
     * @return The arguments map. If no arguments supplied then returns an empty map.
    ](http://help.eclipse.org/mars/topic/org.eclipse.platform.doc.isv/reference/api/org/eclipse/core/resources/ICommand.html.getArguments--) */
