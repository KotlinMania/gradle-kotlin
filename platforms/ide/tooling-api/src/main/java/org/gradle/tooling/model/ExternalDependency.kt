...
interface ExternalDependency : Dependency {
     ...
     *
     * @return The source directory or archive for this dependency, or `null` if no source is available.
     */
    val source: File?
     ...
     *
     * @return the Javadoc directory or archive for this dependency, or `null` if no Javadoc is available.
     */
    val javadoc: File?
     ...
     *
     * @return The Gradle module information for this dependency, or `null` if the dependency does not
     * originate from a remote repository.
     * @since 1.1
     */
