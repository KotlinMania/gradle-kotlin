 ...
 *
 * Similarly to [RunEclipseSynchronizationTasks], this is a special tooling model as it does
 * not provide any information. However, when requested, Gradle will override the client-provided
 * tasks with the ones stored in the `eclipse.autoBuildTasks` property.
 *
 * @since 5.4
 */
