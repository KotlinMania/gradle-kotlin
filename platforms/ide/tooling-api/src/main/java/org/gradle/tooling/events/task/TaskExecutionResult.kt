 ...
 * @since 5.1
 */
interface TaskExecutionResult : TaskOperationResult {
    /**
     * Returns whether this task was executed incrementally.
     *
     * @return `true` if this task was executed incrementally
     ...
     * `null` that it failed before up-to-date checks had been performed.
     * @throws UnsupportedMethodException For Gradle versions older than 5.1, where this method is not supported.
     */
