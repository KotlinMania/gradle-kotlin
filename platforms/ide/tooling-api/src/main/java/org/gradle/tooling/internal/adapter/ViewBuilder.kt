...
interface ViewBuilder<T> {
    /**
     * Mixes the given object into all views of the given type created using [.build].
     ...
     * @return this
     */
    fun mixInTo(targetType: Class<*>, mixIn: Any): ViewBuilder<T?>?

    /**
     * Mixes the given type into all views of the given type created using [.build].
     ...
     * @return this
     */
    fun mixInTo(targetType: Class<*>, mixInType: Class<*>): ViewBuilder<T?>?

    /**
     * Creates a view for the given source object. Returns null when source object is null.
     */
    fun build(sourceObject: Any?): T?
}
