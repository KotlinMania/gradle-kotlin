 ...
 * All Problems that occurred more than once during the build are aggregated and sent as a [ProblemAggregation].
 * They won't be sent in between the build only the first one.
 *
 * @since 8.8
 */
@Incubating
interface ProblemAggregationEvent : ProblemEvent {
    /**
