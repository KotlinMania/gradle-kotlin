...
class IdeaProjectJavaLanguageSettingsMixin(private val ideaProject: IdeaProject) {
    val javaLanguageSettings: CompatibilityIdeaProjectJavaLanguageSettings
        get() = CompatibilityIdeaProjectJavaLanguageSettings(ideaProject)
