...
class DefaultProjectConfigurationOperationDescriptor(descriptor: InternalProjectConfigurationDescriptor, parent: OperationDescriptor?) : DefaultOperationDescriptor(descriptor, parent),
