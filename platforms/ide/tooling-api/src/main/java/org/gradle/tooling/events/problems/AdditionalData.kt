 ...
 *
 *
 * For an example to provide [CustomAdditionalData], see [here](https://docs.gradle.org/current/samples/sample_problems_api_usage.html).
 *
...
interface AdditionalData {
     ...
     * @since 8.6
     */
    val asMap: MutableMap<String, Any>?
}
