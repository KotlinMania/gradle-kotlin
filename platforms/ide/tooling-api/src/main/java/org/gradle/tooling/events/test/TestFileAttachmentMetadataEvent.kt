...
@NullMarked
@Incubating
interface TestFileAttachmentMetadataEvent : TestMetadataEvent {
    /**
    ...
    /**
     * [Media type](https://www.iana.org/assignments/media-types/media-types.xhtml) of the file, if known.
