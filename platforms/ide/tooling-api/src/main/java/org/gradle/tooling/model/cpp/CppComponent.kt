...
interface CppComponent {
    ...
    /**
     * All binaries buildable for this component. These will implement [CppExecutable], [CppSharedLibrary] or [CppStaticLibrary].
     */
    val binaries: DomainObjectSet<out CppBinary?>?
