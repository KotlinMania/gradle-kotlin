...
class DefaultWorkItemFailureResult(startTime: Long, endTime: Long, failures: MutableList<out Failure?>?) : DefaultOperationFailureResult(startTime, endTime, failures), WorkItemFailureResult
