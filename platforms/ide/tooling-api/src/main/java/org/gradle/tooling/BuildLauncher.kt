 ...
 *
 *
 *  * Create an instance of `BuildLauncher` by calling [ProjectConnection.newBuild].
 ...
 *
 *
 * If the target Gradle version is &gt;=6.8 then you can use `BuildLauncher` to execute tasks from included builds. You can target tasks from included builds by specifying the task
...
interface BuildLauncher : ConfigurableLauncher<BuildLauncher?> {
     ...
     * @since 1.0-milestone-3
     */
    fun forTasks(vararg tasks: String?): BuildLauncher?
     ...
     * @since 1.0-milestone-3
     */
    fun forTasks(vararg tasks: Task?): BuildLauncher?
     ...
     * @since 1.0-milestone-3
     */
    fun forTasks(tasks: Iterable<out Task?>?): BuildLauncher?
     ...
     * @since 1.12
     */
    fun forLaunchables(vararg launchables: Launchable?): BuildLauncher?
     ...
     * @since 1.12
     */
    fun forLaunchables(launchables: Iterable<out Launchable?>?): BuildLauncher?
