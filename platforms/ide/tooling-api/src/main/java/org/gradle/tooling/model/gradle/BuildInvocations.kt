 ...
 *
 *
 * To launch a build, you pass one or more [org.gradle.tooling.model.Launchable] instances
...
interface BuildInvocations : Model, ProjectModel {
     ...
     *
     * Selector is a [org.gradle.tooling.model.Launchable] that requests to build all tasks with a given name in context of some project and all its subprojects.
     * @return The task selectors.
     * @since 1.12
     */
    val taskSelectors: DomainObjectSet<out TaskSelector?>?
     ...
     * @since 1.12
     */
    val tasks: DomainObjectSet<out Task?>?
}
