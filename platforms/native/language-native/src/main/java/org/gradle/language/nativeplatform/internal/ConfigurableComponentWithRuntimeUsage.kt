 ...
 */
interface ConfigurableComponentWithRuntimeUsage : ComponentWithRuntimeUsage, ComponentWithNames {
    ...
    val runtimeFile: Provider<RegularFile?>?

    val runtimeAttributes: AttributeContainer?
}
