...
abstract class ObjectiveCppPreCompiledHeaderCompile : AbstractNativePCHCompileTask() {
    override fun createCompileSpec(): NativeCompileSpec {
        return DefaultObjectiveCppPCHCompileSpec()
    }
}
