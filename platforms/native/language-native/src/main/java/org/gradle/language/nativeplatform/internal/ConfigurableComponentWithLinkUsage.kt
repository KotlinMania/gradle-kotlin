 ...
 */
interface ConfigurableComponentWithLinkUsage : ComponentWithLinkUsage, ComponentWithNames {
    ...
    val linkFile: Provider<RegularFile?>?

    val linkAttributes: AttributeContainer?
}
