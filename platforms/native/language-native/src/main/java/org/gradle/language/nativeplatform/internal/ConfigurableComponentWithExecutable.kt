 ...
 */
interface ConfigurableComponentWithExecutable : ComponentWithExecutable, ComponentWithInstallation, ComponentWithObjectFiles, ComponentWithOutputs, ComponentWithNames {
    ...
    override fun getExecutableFile(): Property<RegularFile?>?

    override fun getExecutableFileProducer(): Property<Task?>?

    val debuggerExecutableFile: Property<RegularFile?>?

    override fun getInstallDirectory(): Property<Directory?>?
