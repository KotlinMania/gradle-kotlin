...
public abstract class MachineArchitecture implements Named {
    public static final Attribute<MachineArchitecture> ARCHITECTURE_ATTRIBUTE = Attribute.<MachineArchitecture>of("org.gradle.native.architecture", MachineArchitecture.class);
