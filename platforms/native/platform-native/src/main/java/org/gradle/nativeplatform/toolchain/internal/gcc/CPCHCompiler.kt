...
) : GccCompatibleNativeCompiler<CPCHCompileSpec?>(
    buildOperationExecutor,
    compilerOutputFileNamingSchemeFactory,
    commandLineTool,
    invocationContext,
    CPCHCompileArgsTransformer(),
    Transformers.noOpTransformer<CPCHCompileSpec?>(),
    objectFileExtension,
    useCommandFile,
    workerLeaseService
) {
    private class CPCHCompileArgsTransformer : GccCompilerArgsTransformer<CPCHCompileSpec?>() {
