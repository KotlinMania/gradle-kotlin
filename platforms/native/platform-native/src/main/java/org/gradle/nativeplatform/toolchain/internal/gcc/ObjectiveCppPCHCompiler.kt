...
class ObjectiveCppPCHCompiler(
    ...
    Transformers.noOpTransformer<ObjectiveCppPCHCompileSpec?>(),
    objectFileExtension,
    useCommandFile,
    workerLeaseService
) {
    private class ObjectiveCppPCHCompileArgsTransformer : GccCompilerArgsTransformer<ObjectiveCppPCHCompileSpec?>() {
