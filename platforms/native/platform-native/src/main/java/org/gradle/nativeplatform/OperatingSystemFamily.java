...
public abstract class OperatingSystemFamily implements Named {
    public static final Attribute<OperatingSystemFamily> OPERATING_SYSTEM_ATTRIBUTE = Attribute.<OperatingSystemFamily>of("org.gradle.native.operatingSystem", OperatingSystemFamily.class);
