...
) : GccCompatibleNativeCompiler<CCompileSpec?>(
    buildOperationExecutor,
    compilerOutputFileNamingSchemeFactory,
    commandLineToolInvocationWorker,
    invocationContext,
    CCompileArgsTransformer(),
    Transformers.noOpTransformer<CCompileSpec?>(),
    objectFileExtension,
    useCommandFile,
    workerLeaseService
) {
    private class CCompileArgsTransformer : GccCompilerArgsTransformer<CCompileSpec?>() {
