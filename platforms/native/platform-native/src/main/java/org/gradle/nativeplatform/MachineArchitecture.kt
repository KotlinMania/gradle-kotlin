...
abstract class MachineArchitecture : Named {
    ...
    companion object {
        val ARCHITECTURE_ATTRIBUTE: Attribute<MachineArchitecture?> = Attribute.of<MachineArchitecture?>("org.gradle.native.architecture", MachineArchitecture::class.java)
         ...
         */
        const val X86_64: String = "x86-64"
         ...
         */
        @Incubating
        const val ARM64: String = "aarch64"
    }
}
