...
class VisualCppInstall(
    private val name: String?, val version: VersionNumber?,
    private val platforms: MutableMap<Architecture?, out VisualCpp?>
) : Named {
    override fun getName(): String? {
        return name
    }

    fun forPlatform(targetPlatform: NativePlatformInternal): VisualCpp? {
    ...
    private fun getPlatformArchitecture(targetPlatform: NativePlatformInternal): Architecture? {
