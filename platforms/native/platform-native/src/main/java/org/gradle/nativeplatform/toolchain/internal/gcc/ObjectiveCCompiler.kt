...
internal class ObjectiveCCompiler(
    ...
    Transformers.noOpTransformer<ObjectiveCCompileSpec?>(),
    objectFileExtension,
    useCommandFile,
    workerLeaseService
) {
    private class ObjectiveCCompileArgsTransformer : GccCompilerArgsTransformer<ObjectiveCCompileSpec?>() {
