 ...
 */
abstract class StandardToolChainsPlugin : Plugin<Project?> {
    override fun apply(project: Project) {
        project.getPluginManager().apply(MicrosoftVisualCppCompilerPlugin::class.java)
        project.getPluginManager().apply(GccCompilerPlugin::class.java)
        project.getPluginManager().apply(ClangCompilerPlugin::class.java)
    }
}
