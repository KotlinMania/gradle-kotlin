...
class ObjectiveCPCHCompiler(
    ...
    commandLineTool,
    invocationContext,
    ObjectiveCPCHCompileArgsTransformer(),
    Transformers.noOpTransformer<ObjectiveCPCHCompileSpec?>(),
    objectFileExtension,
    useCommandFile,
    workerLeaseService
) {
    private class ObjectiveCPCHCompileArgsTransformer : GccCompilerArgsTransformer<ObjectiveCPCHCompileSpec?>() {
