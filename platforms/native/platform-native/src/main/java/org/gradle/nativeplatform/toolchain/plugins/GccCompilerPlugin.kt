...
/**
 * A [Plugin] which makes the [GNU GCC/G++ compiler](http://gcc.gnu.org/) available for compiling C/C++ code.
 */
@Incubating
@NullMarked
abstract class GccCompilerPlugin : Plugin<Project?> {
    override fun apply(project: Project) {
        ...
        toolChainRegistry.registerBinding<Gcc>(Gcc::class.java, GccToolChain::class.java)
        toolChainRegistry.registerDefaultToolChain(GccToolChain.DEFAULT_NAME, Gcc::class.java)
    }
}
