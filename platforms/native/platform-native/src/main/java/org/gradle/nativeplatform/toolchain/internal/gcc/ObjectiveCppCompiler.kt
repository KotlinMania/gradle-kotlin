...
internal class ObjectiveCppCompiler(
    ...
    Transformers.noOpTransformer<ObjectiveCppCompileSpec?>(),
    objectFileExtension,
    useCommandFile,
    workerLeaseService
) {
    private class ObjectiveCppCompileArgsTransformer : GccCompilerArgsTransformer<ObjectiveCppCompileSpec?>() {
