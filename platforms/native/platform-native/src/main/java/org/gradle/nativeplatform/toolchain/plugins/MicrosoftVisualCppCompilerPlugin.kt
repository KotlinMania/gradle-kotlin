 ...
 */
@Incubating
abstract class MicrosoftVisualCppCompilerPlugin : Plugin<Project?> {
    override fun apply(project: Project) {
        ...
        toolChainRegistry.registerBinding<VisualCpp?>(VisualCpp::class.java, VisualCppToolChain::class.java)
        toolChainRegistry.registerDefaultToolChain(VisualCppToolChain.DEFAULT_NAME, VisualCpp::class.java)
    }
}
