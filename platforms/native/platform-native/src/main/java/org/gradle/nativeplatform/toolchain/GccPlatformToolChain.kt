...
interface GccPlatformToolChain : NativePlatformToolChain {
     ...
     */
    fun getcCompiler(): GccCommandLineToolConfiguration?

    /**
     * Returns the settings to use for the C++ compiler.
     */
    val cppCompiler: GccCommandLineToolConfiguration?

    /**
     * Returns the settings to use for the Objective-C compiler.
     */
    val objcCompiler: GccCommandLineToolConfiguration?

    /**
     * Returns the settings to use for the Objective-C++ compiler.
     */
    val objcppCompiler: GccCommandLineToolConfiguration?

    /**
     * Returns the settings to use for the assembler.
     */
    val assembler: GccCommandLineToolConfiguration?

    /**
     * Returns the settings to use for the linker.
     */
    val linker: GccCommandLineToolConfiguration?

    /**
     * Returns the settings to use for the archiver.
     */
    val staticLibArchiver: GccCommandLineToolConfiguration?
}
