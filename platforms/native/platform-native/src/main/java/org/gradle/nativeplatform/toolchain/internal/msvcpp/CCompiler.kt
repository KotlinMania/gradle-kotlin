...
internal class CCompiler(
    ...
    specTransformer: Transformer<CCompileSpec?, CCompileSpec?>,
    objectFileExtension: String?,
    useCommandFile: Boolean,
    workerLeaseService: WorkerLeaseService?
) : VisualCppNativeCompiler<CCompileSpec?>(
    ...
    private class CCompilerArgsTransformer : VisualCppCompilerArgsTransformer<CCompileSpec?>() {
        val languageOption: Optional<String?>
            get() = Optional.of<String?>("/TC")
    }
}
