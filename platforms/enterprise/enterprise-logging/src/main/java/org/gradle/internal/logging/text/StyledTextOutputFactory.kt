...
interface StyledTextOutputFactory {
    /**
     ...
     * @return the output
     */
    fun create(logCategory: String?): StyledTextOutput?
     ...
     * @return the output
     */
    fun create(logCategory: Class<*>?): StyledTextOutput?
     ...
     * @return the output
     */
    fun create(logCategory: Class<*>?, logLevel: LogLevel?): StyledTextOutput?
     ...
     * @return the output
     */
    fun create(logCategory: String?, logLevel: LogLevel?): StyledTextOutput?
}
