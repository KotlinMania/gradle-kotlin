...
interface ProgressLoggerFactory {
     ...
     */
    fun newOperation(loggerCategory: String?): ProgressLogger?
     ...
     * @return The progress logger for the operation.
     */
    fun newOperation(loggerCategory: Class<*>?): ProgressLogger?
     ...
     * @return the progress logger for the operation.
     */
    fun newOperation(loggerCategory: Class<*>?, buildOperationDescriptor: BuildOperationDescriptor?): ProgressLogger?

    fun newOperation(loggerClass: Class<*>?, parent: ProgressLogger?): ProgressLogger?
}
