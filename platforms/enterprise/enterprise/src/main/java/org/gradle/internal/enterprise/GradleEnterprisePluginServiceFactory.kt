 ...
 */
interface GradleEnterprisePluginServiceFactory : Serializable {
    /**
     * Creates a per-build-invocation plugin service.
     *
     ...
     */
    fun create(
        config: GradleEnterprisePluginConfig,
        requiredServices: GradleEnterprisePluginRequiredServices,
        buildState: GradleEnterprisePluginBuildState
    ): GradleEnterprisePluginService?
}
