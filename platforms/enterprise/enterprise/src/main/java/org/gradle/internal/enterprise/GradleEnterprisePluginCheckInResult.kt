...
interface GradleEnterprisePluginCheckInResult {
    /**
     ...
     *
     * @throws IllegalStateException if [.getUnsupportedMessage] is non null
     */
    val pluginServiceRef: GradleEnterprisePluginServiceRef?
}
