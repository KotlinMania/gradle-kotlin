...
class DefaultGradleEnterprisePluginAdapterFactory(
    ...
    fun create(pluginServiceFactory: GradleEnterprisePluginServiceFactory): DefaultGradleEnterprisePluginAdapter {
        return DefaultGradleEnterprisePluginAdapter(
