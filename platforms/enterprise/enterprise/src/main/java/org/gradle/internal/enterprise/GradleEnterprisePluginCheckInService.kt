...
interface GradleEnterprisePluginCheckInService {
    /**
     ...
     */
    fun checkIn(
        pluginMetadata: GradleEnterprisePluginMetadata,
        serviceFactory: GradleEnterprisePluginServiceFactory
    ): GradleEnterprisePluginCheckInResult?
}
