...
class TestTaskPropertiesServices : AbstractGradleModuleServices() {
    public override fun registerProjectServices(registration: ServiceRegistration) {
        registration.add<DefaultTestTaskPropertiesService?>(TestTaskPropertiesService::class.java, DefaultTestTaskPropertiesService::class.java)
    }
}
