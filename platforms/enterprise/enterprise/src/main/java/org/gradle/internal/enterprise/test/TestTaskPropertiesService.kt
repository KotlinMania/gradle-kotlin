...
/**
 * Provides access to the configuration of [Test] tasks and allows
 * disabling storing their outputs in the build cache.
 */
@ServiceScope(Scope.Project::class)
interface TestTaskPropertiesService {
    /**
     * Collect the configuration of the given task.
     */
    fun collectProperties(task: Test): TestTaskProperties?
     ...
     */
    fun doNotStoreInCache(task: Test)
}
