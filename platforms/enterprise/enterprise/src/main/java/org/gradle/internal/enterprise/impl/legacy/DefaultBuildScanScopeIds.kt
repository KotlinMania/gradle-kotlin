...
class DefaultBuildScanScopeIds(private val buildInvocationId: BuildInvocationScopeId, private val workspaceId: WorkspaceScopeId, private val userId: UserScopeId) : BuildScanScopeIds {
