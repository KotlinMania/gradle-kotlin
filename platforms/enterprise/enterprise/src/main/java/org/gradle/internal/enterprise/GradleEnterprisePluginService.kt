 ...
 */
interface GradleEnterprisePluginService {
    /**
     ...
     */
    val buildOperationNotificationListener: BuildOperationNotificationListener?

    /**
     * Notified when the build invocation has finished by Gradle.
     */
    val endOfBuildListener: GradleEnterprisePluginEndOfBuildListener?
}
