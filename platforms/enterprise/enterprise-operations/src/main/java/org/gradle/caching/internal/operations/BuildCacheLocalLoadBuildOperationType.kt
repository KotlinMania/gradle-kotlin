 ...
 * @since 8.6
 */
class BuildCacheLocalLoadBuildOperationType private constructor() : BuildOperationType<BuildCacheLocalLoadBuildOperationType.Details, BuildCacheLocalLoadBuildOperationType.Result> {
    interface Details {
        /**
         * The cache key.
         *
