...
enum class CachingDisabledReasonCategory {
    /**
    ...
    /**
     * The work has a `org.gradle.api.file.FileTree` or `org.gradle.api.internal.file.collections.DirectoryFileTree` as an output.
     *
     * @since 5.0
     */
     ...
     *
     *
     * E.g. for a task caching is disabled via `org.gradle.api.tasks.TaskOutputs#cacheIf(Spec)`.
     */
     ...
     *
     *
     * E.g. for a task, caching is disabled via `org.gradle.api.tasks.TaskOutputs#doNotCacheIf(String, Spec)`.
     */
