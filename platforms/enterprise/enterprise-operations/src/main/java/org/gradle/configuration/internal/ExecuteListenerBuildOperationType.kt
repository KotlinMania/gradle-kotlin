 ...
 *
 * Expected to be the child operation of an operation indicating the lifecycle event (e.g. [NotifyProjectBeforeEvaluatedBuildOperationType]).
 *
 * @since 4.10
 */
