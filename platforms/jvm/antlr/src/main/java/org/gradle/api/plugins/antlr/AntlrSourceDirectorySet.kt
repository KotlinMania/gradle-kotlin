 ...
 * injecting a virtual directory named 'antlr' into the project's various [source][org.gradle.api.tasks.SourceSet].
 *
 * @since 7.1
 */
interface AntlrSourceDirectorySet : SourceDirectorySet {
    companion object {
        /**
