 ...
 */
interface JvmLanguageSourceDirectoryBuilder {
    /**
     * The description of the source directory set.
     * If not called Gradle will generate a default description.
     * @param description the description
     */
    fun withDescription(description: String?): JvmLanguageSourceDirectoryBuilder?

    /**
     * Tells how to compile this source directory set.
     * @param taskBuilder the builder for the task which compiles sources
     */
    fun compiledBy(taskBuilder: Function<DirectoryProperty?, TaskProvider<out AbstractCompile?>?>?): JvmLanguageSourceDirectoryBuilder?
     ...
     * Implicitly calls [.includeInAllJava]
     * @param compilerConfiguration the configuration of the compile task
     */
    fun compiledWithJava(compilerConfiguration: Action<in JavaCompile?>?): JvmLanguageSourceDirectoryBuilder?

    /**
     * Includes this source directory in the "allJava" source set
     */
    fun includeInAllJava(): JvmLanguageSourceDirectoryBuilder?
}
