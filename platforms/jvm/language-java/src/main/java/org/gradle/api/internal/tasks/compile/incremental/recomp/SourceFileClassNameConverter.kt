...
interface SourceFileClassNameConverter {
    /**
     * Returns the classes that were compiled from this source file or an empty set if unknown.
     */
    fun getClassNames(sourceFileRelativePath: String?): MutableSet<String?>?
     ...
     */
    fun getRelativeSourcePaths(className: String?): MutableSet<String?>?
     ...
     */
    fun getRelativeSourcePathsThatExist(className: String?): MutableSet<String?>?
}
