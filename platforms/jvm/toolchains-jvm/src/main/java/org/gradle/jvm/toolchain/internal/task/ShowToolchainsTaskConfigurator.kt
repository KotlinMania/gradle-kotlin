...
class ShowToolchainsTaskConfigurator : ProjectConfigureAction {
    override fun execute(project: ProjectInternal) {
        project.getTasks().register<ShowToolchainsTask>("javaToolchains", ShowToolchainsTask::class.java, Action { task: ShowToolchainsTask ->
