 ...
 */
class JvmLanguageUtilsServices : AbstractGradleModuleServices() {
    public override fun registerProjectServices(registration: ServiceRegistration) {
        registration.add<DefaultJvmLanguageUtilities?>(JvmLanguageUtilities::class.java, DefaultJvmLanguageUtilities::class.java)
    }
}
