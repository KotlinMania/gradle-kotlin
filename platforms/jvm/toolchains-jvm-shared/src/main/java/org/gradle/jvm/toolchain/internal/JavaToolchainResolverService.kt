...
interface JavaToolchainResolverService {
    /**
     ...
     * @since 8.13
     */
    fun tryResolve(request: JavaToolchainRequest?): Optional<JavaToolchainDownload?>?

    /**
     * Indicates whether there are any configured toolchain repositories.
     *
     * @return `true` if there are any configured toolchain repositories, `false` otherwise.
     *
     * @since 8.13
     */
