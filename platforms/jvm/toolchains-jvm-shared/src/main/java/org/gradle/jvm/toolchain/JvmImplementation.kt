 ...
 * @since 6.8
 */
class JvmImplementation private constructor(displayName: String) {
    ...
    companion object {
         ...
         */
        @JvmField
        val VENDOR_SPECIFIC: JvmImplementation = JvmImplementation("vendor-specific")
         ...
         */
        val J9: JvmImplementation = JvmImplementation("J9")
    }
}
