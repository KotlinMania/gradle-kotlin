...
object AnnotationProcessorFilter {
    fun getFilteredClassLoader(parent: ClassLoader): FilteringClassLoader {
        return FilteringClassLoader(parent, extraAllowedPackages)
    }

    private val extraAllowedPackages: FilteringClassLoader.Spec
        /**
