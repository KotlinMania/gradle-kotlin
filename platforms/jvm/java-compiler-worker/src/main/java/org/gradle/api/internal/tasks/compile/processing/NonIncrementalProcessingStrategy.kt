 ...
 */
class NonIncrementalProcessingStrategy internal constructor(private val name: String?, result: AnnotationProcessorResult) : IncrementalProcessingStrategy(result) {
    init {
        result.setType(IncrementalAnnotationProcessorType.UNKNOWN)
    }
