 ...
 * @since 7.0
 */
interface TargetJvmEnvironment : Named {
    companion object {
        @JvmField
        val TARGET_JVM_ENVIRONMENT_ATTRIBUTE: Attribute<TargetJvmEnvironment> = Attribute.of<TargetJvmEnvironment>("org.gradle.jvm.environment", TargetJvmEnvironment::class.java)
