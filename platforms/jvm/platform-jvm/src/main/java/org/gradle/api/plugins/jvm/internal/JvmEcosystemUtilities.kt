 ...
 *
 * New code should use [JvmPluginServices] instead.
 *
 * @see [Removal of JvmEcosystemUtilities Issue](https://github.com/gradle/gradle/issues/25542)
 */
@Deprecated("")
interface JvmEcosystemUtilities {
    /**
