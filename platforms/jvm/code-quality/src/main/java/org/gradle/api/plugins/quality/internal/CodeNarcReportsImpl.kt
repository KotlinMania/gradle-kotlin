...
class CodeNarcReportsImpl @Inject constructor(owner: Describable, objectFactory: ObjectFactory) : DelegatingReportContainer<SingleFileReport>(
    DefaultReportContainer.create<SingleFileReport>(
        ...
        DefaultReportContainer.ReportGenerator { factory: DefaultReportContainer.ReportFactory<SingleFileReport>? ->
            ImmutableList.of<SingleFileReport>(
                ...
                factory.instantiateReport<DefaultSingleFileReport>(DefaultSingleFileReport::class.java, "text", owner),
                factory.instantiateReport<DefaultSingleFileReport>(DefaultSingleFileReport::class.java, "console", owner)
            )
        })
), CodeNarcReports {
    ...
    override fun getText(): SingleFileReport {
