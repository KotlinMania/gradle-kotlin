 ...
 */
interface PluginResolutionVisitor {
    /**
     ...
     */
    fun visitReplacement(original: ModuleIdentifier?, replacement: ModuleIdentifier?)

    /**
     * Visit a classloader that provides classes for the plugin.
     */
    fun visitClassLoader(classLoader: ClassLoader?)
}
