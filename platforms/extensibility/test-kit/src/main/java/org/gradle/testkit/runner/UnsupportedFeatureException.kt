 ...
 *
 * @since 2.11
 * @see GradleRunner.withGradleVersion
 * @see GradleRunner.withGradleInstallation
 * @see GradleRunner.withGradleDistribution
 */
class UnsupportedFeatureException : RuntimeException {
    constructor(feature: String?, targetGradleVersion: GradleVersion, minSupportedGradleVersion: GradleVersion) : super(
        String.format(
