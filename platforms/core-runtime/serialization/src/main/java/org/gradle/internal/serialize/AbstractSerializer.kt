...
/**
 * This abstract class provide a sensible default implementation for `Serializer` equality. This equality
...
abstract class AbstractSerializer<T> : Serializer<T?> {
    override fun equals(obj: Any?): Boolean {
        ...
        return Objects.equal(obj.javaClass, javaClass)
    }

    override fun hashCode(): Int {
        return Objects.hashCode(javaClass)
    }
}
