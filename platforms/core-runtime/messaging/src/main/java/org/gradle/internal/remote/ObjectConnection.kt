 ...
 *
 * NOTE: This contract guarantees only partial thread-safety. Configuration and [.connect] are not thread-safe and must be performed by the same thread,
 ...
 */
interface ObjectConnection : AsyncStoppable, ObjectConnectionBuilder {
    /**
    ...
    /**
     * Indicate that the execution containing this `ObjectConnection` has been prematurely stopped.
     */
    fun abort()
     ...
     */
    fun addUnrecoverableErrorHandler(handler: Action<Throwable?>?)
}
