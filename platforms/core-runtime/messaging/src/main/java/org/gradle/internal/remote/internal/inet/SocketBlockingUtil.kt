...
internal object SocketBlockingUtil {
    private val LOGGER: Logger = LoggerFactory.getLogger(SocketBlockingUtil::class.java)

    @Throws(IOException::class)
    fun configureNonblocking(socket: SocketChannel) {
