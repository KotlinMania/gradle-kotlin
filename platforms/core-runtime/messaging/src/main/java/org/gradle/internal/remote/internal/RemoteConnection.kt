...
/**
 *
 * A messaging end-point with some remote, or otherwise unreliable, peer.
 *
 *
 * This interface simply specializes the exceptions thrown by the methods of this connection.
 */
interface RemoteConnection<T> : Connection<T?> {
    /**
     * {@inheritDoc}
     *
