 ...
 * Covers both Java agents (`-javaagent:`) and native JVMTI agents
 * (`-agentlib:`, `-agentpath:`).
 *
 *
 * The result is computed on first call from the JVM's startup arguments and cached.
...
object ThirdPartyAgentDetection {
    ...
    @JvmStatic
    val isThirdPartyAgentPresent: Boolean
        get() = PRESENT.get()!!
}
