 ...
 *
 *
 * The interceptor serves as a factory for decorated Groovy [CallSite] instances.
...
interface CallInterceptor {
     ...
     * The implementation may choose to delegate to the original Groovy implementation by returning the value of `invocation.callOriginal()`.
     *
    ...
    fun intercept(invocation: Invocation, consumer: String): Any?
