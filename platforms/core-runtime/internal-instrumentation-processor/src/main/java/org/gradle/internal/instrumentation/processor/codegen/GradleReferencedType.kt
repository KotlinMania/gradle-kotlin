 ...
 */
enum class GradleReferencedType(name: String) {
    ...
    companion object {
        fun isAssignableToFileSystemLocation(typeName: TypeName): Boolean {
            return typeName == GradleReferencedType.REGULAR_FILE.asClassName()
                    || typeName == GradleReferencedType.DIRECTORY.asClassName()
                    || typeName == GradleReferencedType.FILE_SYSTEM_LOCATION.asClassName()
        }
    }
}
