...
/**
 * Managed version of a [ServiceRegistry] that controls the lifetime of the registry members,
 * such as service instances and factories.
 *
 *
 * Members created by the registry are stopped and closed when this registry is [closed][.close].
 */
interface CloseableServiceRegistry : ServiceRegistry, Closeable {
    /**
     * Closes this registry by stopping and closing all members managed by it.
     *
     *
     * If a member implements [Closeable][Closeable.close] or
