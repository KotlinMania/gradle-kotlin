 ...
 * [org.slf4j.Logger] or a Gradle [Logger] to perform logging.
 */
object Logging {
    val LIFECYCLE: Marker? = MarkerFactory.getDetachedMarker("LIFECYCLE")
    val QUIET: Marker? = MarkerFactory.getDetachedMarker("QUIET")
    ...
    fun getLogger(c: Class<*>): Logger? {
        return LoggerFactory.getLogger(c) as Logger?
    }
