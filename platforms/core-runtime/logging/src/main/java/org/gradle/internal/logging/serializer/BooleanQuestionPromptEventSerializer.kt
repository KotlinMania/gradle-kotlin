...
class BooleanQuestionPromptEventSerializer : Serializer<BooleanQuestionPromptEvent?> {
    ...
    override fun write(encoder: Encoder, value: BooleanQuestionPromptEvent) {
        ...
        encoder.writeBoolean(value.defaultValue)
    }

    @Throws(Exception::class)
    override fun read(decoder: Decoder): BooleanQuestionPromptEvent {
        return BooleanQuestionPromptEvent(decoder.readLong(), decoder.readString(), decoder.readBoolean())
    }
}
