 ...
 */
interface LoggingSourceSystem : LoggingSystem {
    /**
     ...
     *
     *
     * This method should not have any effect when capture is not enabled for this logging system using [.startCapture].
     *
     * @param logLevel The minimum log level.
     * @return the state of this logging system immediately before the changes are applied.
     */
    fun setLevel(logLevel: LogLevel?): LoggingSystem.Snapshot?

    /**
     * Enables generation of logging events from this logging system. This method is always called after [.setLevel].
     *
     * @return the state of this logging system immediately before the changes are applied.
     */
    fun startCapture(): LoggingSystem.Snapshot?
}
