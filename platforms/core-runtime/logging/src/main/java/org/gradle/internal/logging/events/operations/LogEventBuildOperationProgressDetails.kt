...
/**
 * Build operation observer's view of [org.gradle.internal.logging.events.LogEvent].
 *
...
@Deprecated("")
interface LogEventBuildOperationProgressDetails : LogEventBuildOperationProgressDetails {
    /**
     * Replaced by [.getLevel].
     */
