...
class NoOpLoggingSystem : StdOutLoggingSystem, StdErrLoggingSystem, LoggingSourceSystem {
    ...
    private fun dummy(): LoggingSystem.Snapshot {
        return object : LoggingSystem.Snapshot {}
    }
}
