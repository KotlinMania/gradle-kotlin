...
class UsedGradleVersionsFromGradleUserHomeCaches(cacheBuilderFactory: GlobalScopedCacheBuilderFactory) : UsedGradleVersions {
    private val directoryScanner: VersionSpecificCacheDirectoryScanner
