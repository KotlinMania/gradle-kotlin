...
/**
 * More complex HTML generation code that doesn't belong on the [SimpleHtmlWriter] itself.
 */
@NullMarked
object HtmlWriterTools {
    /**
    ...
    fun addClipboardCopyButton(writer: SimpleHtmlWriter, copyElementId: String): SimpleMarkupWriter {
