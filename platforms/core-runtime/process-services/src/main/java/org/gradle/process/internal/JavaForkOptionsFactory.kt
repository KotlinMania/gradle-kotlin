...
interface JavaForkOptionsInternal : JavaForkOptions {
     ...
     */
    fun toEffectiveJavaForkOptions(fileCollectionFactory: FileCollectionFactory?): EffectiveJavaForkOptions?
}
