...
object BuildPlatformFactory {
     ...
     * @return the new [BuildPlatform] instance
     *
     * @since 8.13
     */
    @JvmStatic
    fun of(architecture: Architecture, os: OperatingSystem): BuildPlatform {
        return DefaultBuildPlatform(architecture, os)
    }
}
