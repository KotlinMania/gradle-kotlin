...
class JansiLibraryFactory {
    fun create(): JansiLibrary {
        ...
        var jansiNativeLibraryName = System.mapLibraryName("jansi")
        if (jansiNativeLibraryName.endsWith(".dylib")) {
            jansiNativeLibraryName = jansiNativeLibraryName.replace(".dylib", ".jnilib")
        }
        return JansiLibrary(OSInfo.getNativeLibFolderPathForCurrentOS(), jansiNativeLibraryName)
    }
}
