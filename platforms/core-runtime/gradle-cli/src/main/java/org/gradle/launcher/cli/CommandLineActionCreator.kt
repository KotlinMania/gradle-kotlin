...
/**
 * A factory for creating [Action]s from CLI commands.
 */
interface CommandLineActionCreator {
    /**
     * Configures the given action creator with a command-line parser.
     */
    fun configureCommandLineParser(parser: CommandLineParser?)
     ...
     * @param parameters the parameters created from the command-line args
     * @return `null` if this creator does not know how to create an action from the given command-line args
     */
