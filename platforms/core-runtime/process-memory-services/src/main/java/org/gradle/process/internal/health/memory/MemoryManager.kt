...
interface MemoryManager {
     ...
     *
     * Attempt to free as much memory as possible to get memoryAmountBytes
     * of free memory available on the system.
     *
     * @param memoryAmountBytes The requested amount of memory in bytes. If negative, 0 is assumed.
     */
    fun requestFreeMemory(memoryAmountBytes: Long)
}
