...
/**
 * Base class for service registries that can be used as parents of [DefaultServiceRegistry].
 *
 *
 * Subclasses provide access to their internal [ServiceProvider] via [.asServiceProvider],
