...
/**
 * Provides a set of zero or more services. The get-methods may be called concurrently. [.stop] is guaranteed to be only called once,
 * after all get-methods have completed.
 */
internal interface ServiceProvider : Stoppable {
    /**
